...
<img src="/images/machine learning/005-DT-01.png" width="80%" alt="gecko embed program run error 2" />

假设**错误率相互独立**，由Hoeffding不等式可以得到整体学习器的错误率：
<img src="/images/machine learning/005-DT-02.png" width="80%" alt="gecko embed program run error 2" />m
