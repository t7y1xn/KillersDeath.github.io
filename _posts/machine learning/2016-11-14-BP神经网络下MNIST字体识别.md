...
<img src="/images/machine learning/bp_1.png" width="70%" align="middle"  alt="gecko embed program run error 2" />
<img src="/images/machine learning/bp_2.png" width="70%" align="middle"  alt="gecko embed program run error 2" />
<img src="/images/machine learning/bp_3.png" width="70%" align="middle"  alt="gecko embed program run error 2" />
...
<img src="/images/machine learning/bp_4.png" width="70%" align="middle"  alt="gecko embed program run error 2" />
<img src="/images/machine learning/bp_5.png" width="70%" align="middle"  alt="gecko embed program run error 2" />

网络层中的权重，即通过各个层的误差进行更新。更新权值的思路简单粗暴，1）求梯度；2）梯度下降，梯度求导，核心是采用链式求导法则
<img src="/images/machine learning/bp_6.png" width="70%" align="middle"  alt="gecko embed program run error 2" />
<img src="/images/machine learning/bp_7.png" width="70%" align="middle"  alt="gecko embed program run error 2" />
...
- **梯度下降算法** ![images](http://images.cnblogs.com/cnblogs_com/LeftNotEasy/WindowsLiveWriter/1_1270E/image_24.png)
...
- **数据处理** 在[官网]('http://yann.lecun.com/exdb/mnist/)
...
<img src="/images/machine learning/bp_9.png" align="middle"  width="70%" alt="gecko embed program run error 2" />
